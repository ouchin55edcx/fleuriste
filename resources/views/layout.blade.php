...
<body class="flex flex-col min-h-screen bg-gray-50 overflow-x-hidden">
    <nav class="bg-white shadow-md fixed w-full z-20 transition-all duration-300" id="navbar">
        <div class="container mx-auto px-4">
            <div class="flex justify-between items-center py-4">
                ...
                <div class="hidden md:flex items-center space-x-6">
                    <a href="#" class="nav-link text-gray-600 hover:text-green-600 transition-colors duration-300">Accueil</a>
                    <a href="#" class="nav-link text-gray-600 hover:text-green-600 transition-colors duration-300">Bouquets</a>
                    <a href="#" class="nav-link text-gray-600 hover:text-green-600 transition-colors duration-300 relative">
        ...
        <div class="md:hidden hidden bg-white" id="mobileMenu">
            <a href="#" class="block py-2 px-4 text-gray-600 hover:bg-green-50">Accueil</a>
        ...
        <div class="container mx-auto px-4">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                <div>
                    ...
                    <p class="text-green-200">Des fleurs fraîches livrées à votre porte, pour illuminer votre quotidien.</p>
                </div>
                <div>
                    <h4 class="text-xl font-semibold mb-4">Liens rapides</h4>
                    <ul class="space-y-2">
                        <li><a href="#" class="text-green-200 hover:text-white transition-colors duration-300">Accueil</a></li>
                        <li><a href="#" class="text-green-200 hover:text-white transition-colors duration-300">Bouquets</a></li>
                        <li><a href="#" class="text-green-200 hover:text-white transition-colors duration-300">Comment ça marche</a></li>
                        <li><a href="#" class="text-green-200 hover:text-white transition-colors duration-300">Contact</a></li>
                    </ul>
                </div>
                <div>
                    <h4 class="text-xl font-semibold mb-4">Contact</h4>
                    <ul class="space-y-2">
                        <li class="flex items-center"><i class="fas fa-envelope mr-2"></i>contact@fleursfraîches.com</li>
                        <li class="flex items-center"><i class="fas fa-phone mr-2"></i>+33 1 23 45 67 89</li>
                        <li class="flex items-center"><i class="fas fa-map-marker-alt mr-2"></i>123 Rue des Fleurs, Paris</li>
                    </ul>
                </div>
                <div>
